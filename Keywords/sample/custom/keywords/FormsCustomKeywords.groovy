...
public class FormsCustomKeywords {
	...
	def inputDetailsPracticeForm(String fname, lname, email, number) {
		...
		WebUI.click(findTestObject('Forms_Test6_objects/Page_ToolsQA/gender_Other_Radio'))
		WebUI.setText(findTestObject('Forms_Test6_objects/Page_ToolsQA/number_Input_Field'), number)

		WebUI.scrollToPosition(0, 400)

		WebUI.click(findTestObject('Forms_Test6_objects/Page_ToolsQA/dob_Input_Field'))
		WebUI.selectOptionByValue(findTestObject('Forms_Test6_objects/Page_ToolsQA/monthpicker_Select'), "7", false)
		WebUI.selectOptionByValue(findTestObject('Forms_Test6_objects/Page_ToolsQA/yearpicker_Select'), "1985", false)
		WebUI.click(findTestObject('Forms_Test6_objects/Page_ToolsQA/daypicker_Select'))
		WebUI.setText(findTestObject('Forms_Test6_objects/Page_ToolsQA/subjects_Input_Field'), "English")
		rb.keyPress(KeyEvent.VK_ENTER)
		WebUI.click(findTestObject('Forms_Test6_objects/Page_ToolsQA/hobbies_Reading_Check'))
		WebUI.uploadFile(findTestObject('Forms_Test6_objects/Page_ToolsQA/upload_Picture_Button'), 'C:\\Users\\wahu\\Desktop\\sampleFile.jpg')
		WebUI.setText(findTestObject('Object Repository/Elements_Test1_objects/Page_ToolsQA/textarea_Current Address'), "BGC")
		WebUI.click(findTestObject('Forms_Test6_objects/Page_ToolsQA/state_Dropdown'))
		rb.keyPress(KeyEvent.VK_ENTER)
		WebUI.click(findTestObject('Forms_Test6_objects/Page_ToolsQA/city_Dropdown'))
		rb.keyPress(KeyEvent.VK_ENTER)
	...
	def validateSubmittedDetailsInForm(String name, email, gender, num, dob, pic) {
		String verifyStudnameInfo = 'Object Repository/Forms_Test6_objects/Page_ToolsQA/studName_Info'
		String verifyEmailInfo = 'Object Repository/Forms_Test6_objects/Page_ToolsQA/email_Info'
		String verifyGenderInfo = 'Object Repository/Forms_Test6_objects/Page_ToolsQA/gender_Info'
